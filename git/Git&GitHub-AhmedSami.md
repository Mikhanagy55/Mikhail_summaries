...
ف هو بيشوفها كده ![Pasted image 20250403132411.png](Pasted image 20250403132411.png) الtype بعدين ال sizeاللي هو `11` مش 10 عشان في line break فالاخر مش ظاهر بس الterminal بتحطه. ثم null  character بعدين يحط الtext. 
...
![Pasted image 20250405190623.png](Pasted image 20250405190623.png)
...
السهوله وحلاوه الموضوع لو قولتله ![Pasted image 20250413122822.png](Pasted image 20250413122822.png)مش هاروح بقى اشوف الcommits وال`SHA1` والmessages عشان اعرف انهي واحده هي, بيخليني انط على طول فالversions. 
...
![Pasted image 20250414015042.png](Pasted image 20250414015042.png)
...
الmerge هنا اسمه `three-way merge` وده بيعتمد على التلاته دول![Pasted image 20250426183854.png](Pasted image 20250426183854.png) عشان يعمل الmerge, بيعمل COMMIT جديد revision رابع ولا واحد منهم.
...
![Pasted image 20250426235631.png](Pasted image 20250426235631.png)

Rebasing is the process of moving or combining a sequence of commits to a new base commit. Rebasing is most useful and easily visualized in the context of a feature branching workflow.
![Pasted image 20250426235950.png](Pasted image 20250426235950.png)
***___________________________________________________________________________________________***
...
![Pasted image 20250427002711.png](Pasted image 20250427002711.png)
...
![Pasted image 20250427003106.png](Pasted image 20250427003106.png)
___________________

اقدر أconnect على اكتر من remote.  ![Pasted image 20250427003259.png](Pasted image 20250427003259.png)مثلا في اكتر من شخص على مستوى العالم شغلاين على نفس الrepo وكل واحد عنده النسخه بتاعته بيعدل فيها فأقدر اخد دايما الupdates او أpush التعديلات بتاعتي.
...
عشان اعلم cloning هستخدم `git clone` واديله الlocation بتاع الrepo دي. هو تلقائي بيدي الlocal repo  نفس الاسم بتاع الremote لو لسبب ما كنت عايز اغير الاسم بتاع الlocal repo عندي هاكتب الاسم اللي انا عايزه بعد الlocation.![Pasted image 20250427004919.png](Pasted image 20250427004919.png)
عشان اشوف كل الreomte repos اللي عندي هستخدم `git remote`. ![Pasted image 20250427005439.png](Pasted image 20250427005439.png)ال<mark>_origin_</mark> ده اسمه الshort name. لما اشوف origin دي كده ده معناه ان الrepo أللي شغال عليه ده متاخد من remote repo. 
الorigin ده  اسمه الshort name او ال`alias` بتاع الremote repo. لو عايز اعرف details عن الremote repo ده.  
هستخدم `git remote -v` ![Pasted image 20250427010213.png](Pasted image 20250427010213.png)هلاقي فيه اتنين origin والorigin دي زي alias كده عن الURL بدل ما كل مره  هكتب الURL كله.
...
ده الremote![Pasted image 20250427040606.png](Pasted image 20250427040606.png)
وده الlocal![Pasted image 20250427040609.png](Pasted image 20250427040609.png)

هاجي اشوف ده فالlocal مثلا اجرب `git status` مش هيحس بيه ![Pasted image 20250427033103.png](Pasted image 20250427033103.png)وده مش صح. ازاي انا up to date مع الremote.
لكن ده طبيعي لأنك لسه مجبتش الupdates اللي حصلت فالremote. هي دي اخر حاجه يعرفها الlocal repo انك up to date.

ف by the way, عشان اعرف الbranches اللي جايه من الremote. هنستخدم `git branch -r`.![Pasted image 20250427033502.png](Pasted image 20250427033502.png)
...
![Pasted image 20250427034650.png](Pasted image 20250427034650.png)
بعد `git fetch` هو عرف ان  في commit جديده اتعملت فالremote بس ليه مطبهاش فالWorking tree عندي فالlocal repo.
حتى لما عملت cat-file عندي فالlocal Repo ل الrevision اللي اتضاف فالremote repo لاقيته موجود.![Pasted image 20250427035757.png](Pasted image 20250427035757.png)اللي بيحصل ان `git fetch` بتعمل download لكل الupdates والrevisions ألمختلفه عن الlocal لكن مبتعملهاش `merge` مع الlocal repo والworking tree عندي.
بحيث يبقى في Work flow حتى اعمل `git show` واشوف ايه الدنيا. لو تمام خلاص اعمل `git merge`. 

ف by the way لو جربت اعمل `git status` بعد ما عرف updates لما عملت `git fetch` هلاقيه جابلي الرساله التمام.![Pasted image 20250427040353.png](Pasted image 20250427040353.png)
لما اعمل `git merge` هيعمل update ل الworking tree.![Pasted image 20250427041027.png](Pasted image 20250427041027.png)
و git status خلاص مفيش حاجه انت up to date وتمام.![Pasted image 20250427041327.png](Pasted image 20250427041327.png)
طب لو جربت اعمل تعديل فالlocal. ألlocal repo عارف كل حاجه, هيقولك انت اللي متقدم Commit عن الremote.![Pasted image 20250427041522.png](Pasted image 20250427041522.png)
![Pasted image 20250427041646.png](Pasted image 20250427041646.png)
...
حتى اهو الremote معندوش غير 2commits ![Pasted image 20250427042340.png](Pasted image 20250427042340.png)
...
لو جيت عملت branch في الLocal وعملتله switch  ثم عملتله commit.![Pasted image 20250427045351.png](Pasted image 20250427045351.png)هلاقي ان Git مش شايف ومش فاهم ايه علاقه branch feature بالremote. 
...
`<اسم البرانش> git push`. <اسم البرانش> اللي ه push عليه.![Pasted image 20250427123638.png](Pasted image 20250427123638.png)جابلي الerror ده `the current branch feature has no upstream branch.`.
...
بقوله وانت بتpush اعمل branch اسمه feature فالorigin. اذا الcommand ده هيعمل feature branch وي synchronize الupdates بتاعته.![Pasted image 20250427125047.png](Pasted image 20250427125047.png)![Pasted image 20250427125013.png](Pasted image 20250427125013.png)
واتأكد من ده لما اعمل `git branch` فالremote.
![Pasted image 20250427125202.png](Pasted image 20250427125202.png)

كده تمام بالنسبه `git status`
![Pasted image 20250427125425.png](Pasted image 20250427125425.png)
 هتلاحظ انه المره دي اداني tracking information بين الlocal والremote عن الfeature branch.
  ...
  ___________
  عشان ن synchronize من الremote ل الlocal, عملنا `git fetch` ثم `git merge` الخطوتين دول اقدر اعملهم ب command واحد بس اللي هو `git pull` ![Pasted image 20250427130543.png](Pasted image 20250427130543.png)![Pasted image 20250427130545.png](Pasted image 20250427130545.png)
  ___________
  
![Pasted image 20250427130832.png](Pasted image 20250427130832.png) 
بيlist كل الbranches اللي عندي والlatest commit بتاعتهم و بيحددلي ب `*` ان ده الHEAD.

![Pasted image 20250427130933.png](Pasted image 20250427130933.png) 
...
عشان أclone repo من GitHub ![Pasted image 20250427143550.png](Pasted image 20250427143550.png)
لو نزلت الzip file هاتروح تعمله extract عادي لو فتحته من الterminal هتلاقي في hidden directory اسمه `github.` ![Pasted image 20250427143849.png](Pasted image 20250427143849.png)بس مفيش `git.` الrepo يعني.
...
![Pasted image 20250427144515.png](Pasted image 20250427144515.png)
ولما اخش الdirectry هلاقيه عرف انه repo ![Pasted image 20250427144548.png](Pasted image 20250427144548.png)
...
ممكن انا اعمل repository عادي عن طريق اني أclick على <mark>__New__</mark>. ![Pasted image 20250427195920.png](Pasted image 20250427195920.png)
...
______
![Pasted image 20250427201611.png](Pasted image 20250427201611.png)
...
وعلى حسب الextesion اللي هتضيفه ل الfile فGitHub بيrecognise الfile ده.![Pasted image 20250427203301.png](Pasted image 20250427203301.png)
و بيقولك اعمل commit وبيقترح عليك الcommit message.
![Pasted image 20250427203419.png](Pasted image 20250427203419.png)

وهلاقي تأثير ده حصل هنا اهو![Pasted image 20250427203505.png](Pasted image 20250427203505.png)قالك عندك 2 commits وضاف الfile اهو, وال`SHA1` بتاع الlatest commit.
لو دوست على Commits هيظهرلي الcommits اللي عندي كده ![Pasted image 20250427203803.png](Pasted image 20250427203803.png) لو دوست على ال`SHA1` بتاع اي واحده هايقولي ايه اللي حصل فيها.![Pasted image 20250427203906.png](Pasted image 20250427203906.png)

ممكن ابدأ اconverse مع الناس اللي بتشوف الrepo بتاعي. كل واحد يقدر يسيب comment.
و موجود ده برضو فالissues ![Pasted image 20250427205704.png](Pasted image 20250427205704.png)مثلا يقولي في issue فالحته الفلانيه او الcode بيجيب معايا error مثلا. بعدين هو يقترح عليا حلول او أpass ده ل واحد من الcollaborators عشان يعدل.
...
_________
لو عايز أcreate Branch هاروح عند كلمه `main` و اكتب اسم الbranch ده.![Pasted image 20250427211543.png](Pasted image 20250427211543.png)و أclick على `create branch: feature`.
الbranch اللي اسمه بيبقى مكان الmain كده هو ده ال<mark>_current branch_</mark>.

![Pasted image 20250427211825.png](Pasted image 20250427211825.png)
ف انا هنا على الfeature branch واي تعديل هعمله هيبقى committed على ال feature branchده.![Pasted image 20250427212144.png](Pasted image 20250427212144.png)بعد ماتعمل الcommit 
...
هلاقيه مقترح الmessage عادي. و بيقولي انها <mark>able to merge</mark> الfeature branch  ده into الmain branch. ف أclick على __<mark>create pull request</mark>__![Pasted image 20250427214249.png](Pasted image 20250427214249.png)
ثم  __<mark>merge pull request</mark>__ ![Pasted image 20250427214628.png](Pasted image 20250427214628.png) 
ثم  اكتبله ال`commit merge message` و أclick على __<mark>confirm merge</mark>__.![Pasted image 20250427214642.png](Pasted image 20250427214642.png)وأقدر في كل مره اسيب Comment كده.
بس كده الmerge خلص خلاص. ![Pasted image 20250427214915.png](Pasted image 20250427214915.png)ممكن اdelete الbranch عادي لو خلصت اللي انا عايزه.
***___________________________________________________________________________________________***
...
من الطرق المستخدمه 
اننا ن<mark>_create empty repo_</mark>. من الحاجات الحلوه في GitHub انه لما بcreate empty repo هو بيعرف انك هت populate الrepo ده من الdown stream ف بيديني شويه options لكل case. ![Pasted image 20250427222347.png](Pasted image 20250427222347.png)حتى لو تلاحظ دي مظهرتش قبل كده لما خليناه يadd الREADME file واحنا بنcreate الrepo.
...
اهو ونتأكد وكل حاجه![Pasted image 20250427224956.png](Pasted image 20250427224956.png)
عادي نعمل upstream لو اسامي الbranches مختلفه بس ده مش كويس. ف نسمع كلامه تاني ونغير اسم الmaster ل main![Pasted image 20250427225144.png](Pasted image 20250427225144.png)
خلاص كله تمام نعمل اخر حاجه بقى اللي هو نعمل push. عن طريق `git push -u origin main`

![Pasted image 20250427225326.png](Pasted image 20250427225326.png)
...
![Pasted image 20250428015802.png](Pasted image 20250428015802.png)
...
note 
![Pasted image 20250428020226.png](Pasted image 20250428020226.png)
...
![Pasted image 20250428020438.png](Pasted image 20250428020438.png)
...
#### SSH 
![Pasted image 20250428021418.png](Pasted image 20250428021418.png)
![Pasted image 20250428021546.png](Pasted image 20250428021546.png)
...
![Pasted image 20250428022154.png](Pasted image 20250428022154.png)
...
![Pasted image 20250428023733.png](Pasted image 20250428023733.png)
حتى هو بيوريني ازاي اعمل generate ل الkey.

هgenerate ألkey عن طريق الcommand ده![Pasted image 20250428023833.png](Pasted image 20250428023833.png)لازم تتأكد ان الايميل اللي هتكتبه هنا اللي هو على اساسه هيتعمل الkey, يكون هو نفس الemail اللي انت عملت بيه ال configuration ل الgit repo locally عندي.

![Pasted image 20250428025816.png](Pasted image 20250428025816.png)
...
![Pasted image 20250428031416.png](Pasted image 20250428031416.png)
![Pasted image 20250428031444.png](Pasted image 20250428031444.png)

بيقولي تقدر كمان تعمل evaluation تتأكد ان الkey اتعمل صح. ![Pasted image 20250428133037.png](Pasted image 20250428133037.png)الPID بيظهر عشان يأكد إن الـ Agent شغال, وتقدر تستخدم الرقم ده لو عايز تتحكم في العملية (مثلاً توقّفها أو تشوفها).
...
![Pasted image 20250428133856.png](Pasted image 20250428133856.png)
وهاخد الcontent كله copy وارجع ل GitHub و اخش على الssh key setting و أclick على <mark>__New SSH Key__</mark>.
اديله اي اسم ,واحط الkey ![Pasted image 20250428134116.png](Pasted image 20250428134116.png)وأclick على <mark>__Add SSH key__</mark>.

نعمل push بقى.
![Pasted image 20250428134950.png](Pasted image 20250428134950.png)
الpush المره دي نجح.

اتأكد برضو لما تلاقي الlocal والremote عندهم نفس الcommits بلا`SHA1` بتاعهم.![Pasted image 20250428140237.png](Pasted image 20250428140237.png)![Pasted image 20250428140252.png](Pasted image 20250428140252.png)
كده الpush successful.

![Pasted image 20250428140612.png](Pasted image 20250428140612.png)
وهنا بيقولك ان تم استعماله بالفعل.

اقدر اخش على الseeting وبتاعه الrepo واعملله delete.

![Pasted image 20250428030442.png](Pasted image 20250428030442.png)
...
ف محتاج اني اعمل `fetch` عشان اقدر اشوف التعديلات. ![Pasted image 20250428142718.png](Pasted image 20250428142718.png)كده عملت fetch لو عملت git log ![Pasted image 20250428143222.png](Pasted image 20250428143222.png)
ممكن استخدم `all--` عشان يوريني كل الcommits الموجوده سواء remote او local.
![Pasted image 20250428142836.png](Pasted image 20250428142836.png)
هيقولي في واحده ذياده 

عشان الذياده دي اشوفها عندي فالlocal هعمل `git merge`
![Pasted image 20250428143408.png](Pasted image 20250428143408.png)

لو عملت git log هلاقي ال4commits الموجوده.![ Pasted image 20250428143446.png]( Pasted image 20250428143446.png)
أقدر اpublish من على الVS code ![Pasted image 20250428145326.png](Pasted image 20250428145326.png)
...
عشان اعمل fork. هاروح أclick على `fork`![Pasted image 20250428150922.png](Pasted image 20250428150922.png)هتلاحظ ان في 1500 واحد عاملين ل الrepo ده fork.

_______

![Pasted image 20250428151135.png](Pasted image 20250428151135.png)

وهتلاقي كل settings والcommits وال configuration كلها موجوده عندك.

من ضمن الحاجات اللي اقدر اعملها بعد الfork اني أ`Fetch upstream` او أ`contribute`![Pasted image 20250428151806.png](Pasted image 20250428151806.png)
...
او الطبيعي والمنطقي <mark>_اني اعمل cloning من الforked repo بتاعي_</mark> ده.  ![Pasted image 20250428152203.png](Pasted image 20250428152203.png)![Pasted image 20250428152232.png](Pasted image 20250428152232.png)

ولو عملت `git remote -v`![Pasted image 20250428152356.png](Pasted image 20250428152356.png)هلاقي ان الremote بتاع الrepo ده هو من الaccount بتاعي. مش الoriginal اللي واخد منه الfork.

وممكن اضيف remote تاني اللي هو الشخص اللي واخد منه الfork .
![Pasted image 20250428152744.png](Pasted image 20250428152744.png)
...
عشان اعمل ده هاروح ل<mark>pull request</mark>![Pasted image 20250428153905.png](Pasted image 20250428153905.png) و أclick على <mark>__Create pull request__</mark> 
ف هيشوف التعديلات اللي انا عدلتها ومش موجوده فالoriginal ![Pasted image 20250428154009.png](Pasted image 20250428154009.png)و أclick على <mark>__Create pull request__</mark>

واحط الmessage وابدأ اديله تفاصيل عن اللي عملته, و أclick على <mark>__Create pull request__</mark>.

عند الراجل هناك بقى هيفتح الpull request هيلاقي في request جايله منahmed sami ![Pasted image 20250428154309.png](Pasted image 20250428154309.png)
و يا اما يقبله او ي close انه ي ignore يعني.
ويحط comment 
![Pasted image 20250428154601.png](Pasted image 20250428154601.png)
